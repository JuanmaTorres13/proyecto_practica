 ...
 * de usuarios, aplicando la lógica de negocio correspondiente.
 * </p>
 * 
 * @author
 * @version 1.1
...
public class UsuarioService {
	 ...
	 *
	 * <p>
	 * Verifica que el correo electrónico no esté en uso, asigna el rol por defecto
	 * "USER", codifica la contraseña y guarda el usuario en la base de datos.
	 * </p>
	 *
	 * @param request objeto {@link RegistroRequest} con los datos del nuevo usuario
	 * @return el {@link Usuario} recién creado
	 * @throws EmailAlreadyExistsException si el correo electrónico ya está
	 *                                     registrado
	 ...
	 *
	 * <p>
	 * Busca el usuario por correo electrónico y compara la contraseña ingresada con
	 * la almacenada (codificada).
	 * </p>
	 *
	 ...
	 *
	 * <p>
	 * Este método puede utilizarse para actualizar los datos del perfil del
	 * usuario, como nombre, email, ciudad o biografía.
	 * </p>
	 *
	 ...
	 *
	 * <p>
	 * Este método puede ser utilizado para mostrar usuarios en el panel de
	 * administración.
	 * </p>
	 *
